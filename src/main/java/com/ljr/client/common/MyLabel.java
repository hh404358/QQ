	...
	public void addEvent()
	{
		jLabel.addMouseListener(new MouseAdapter(){
			...
			public void mouseEntered(MouseEvent e){
				if(mode == 1) {
					jLabel.setIcon(Utils.getIcon(fileName + "_2." + extension));
				}
				else {
			...
			{
				if(mode == 1) {
					jLabel.setIcon(Utils.getIcon(fileName + "_1." + extension));
				}
				else {
					setEtchedBorder(backColor);
				}
			...
			{
				if(mode == 1) {
					jLabel.setIcon(Utils.getIcon(fileName + "_3." + extension));
				}
				else {
